...
// definindo explicitamente variáveis global scope
...
func Teste() {
	// definindo variaveis com tipagem explicita dentro de funções local scope
	var y float64 = 5.5

	// definindo variável com tipagem implicita possivel somente dentro de funções
	z := 5
	...
	*/
	...
	// estrutura de um for loop: <inicialização>; <condição>; <após a condição validar>
